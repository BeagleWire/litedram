...
static inline uint8_t sdram_dfii_pi0_wrdata_read(void) {
	return csr_read_simple(CSR_BASE + 0x818L);
}
static inline void sdram_dfii_pi0_wrdata_write(uint8_t v) {
	csr_write_simple(v, CSR_BASE + 0x818L);
}
#define CSR_SDRAM_DFII_PI0_RDDATA_ADDR (CSR_BASE + 0x81cL)
#define CSR_SDRAM_DFII_PI0_RDDATA_SIZE 1
static inline uint8_t sdram_dfii_pi0_rddata_read(void) {
